...
*   [问题描述](https://leetcode.cn/problems/stickers-to-spell-word/)
...
*   解题思路_暴力递归
    ...
    *   从起始点开始，步数为0时只能解锁本身
    *   步数+1 看从当前的所有点能够延升出那些点；（这些点就算出现重复值也无所谓，以为它之前的路径是不同的）
...
*   <img src="images/image-20221211162305616.png" alt="image-20221211162305616" style="zoom: 33%;" />
